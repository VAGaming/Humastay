document.addEventListener("DOMContentLoaded", function () {
  ...
  confirmBtn.addEventListener("click", function (e) {
    ...
    document.getElementById("res-sdt").innerText =
      document.getElementById("sdt").value;
    document.getElementById("res-email").innerText =
      document.getElementById("email").value;
    document.getElementById("res-cccd").innerText =
      document.getElementById("cccd").value;
    document.getElementById("res-dob").innerText =
      document.getElementById("ngaySinh").value;
    document.getElementById("res-room").innerText =
    ...
    document.getElementById("res-requests").innerText = selectedRequests.length
  ...
  document.getElementById("xn").addEventListener("click", function () {
    ...
    document.getElementById("pay-name").innerText =
      document.getElementById("res-name").innerText;
    document.getElementById("pay-sdt").innerText =
      document.getElementById("res-sdt").innerText;
    document.getElementById("pay-email").innerText =
      document.getElementById("res-email").innerText;
    document.getElementById("pay-dob").innerText =
      document.getElementById("res-dob").innerText;
    document.getElementById("pay-room").innerText =
      document.getElementById("res-room").innerText;
    document.getElementById("pay-date").innerText =
      document.getElementById("res-date").innerText;
    document.getElementById("pay-total-final").innerText =
      document.getElementById("res-total").innerText;
...
function changePayMethod(el) {
  ...
  if (type === "qr") {
    qrImg.src =
      "https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=VietQR_HUMASTAY";
    qrArea.style.display = "block";
  } else if (type === "momo") {
    qrImg.src =
      "https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=MoMo_HUMASTAY";
    qrArea.style.display = "block";
  } else {
